...
- [**Color API**](../api/Color.md): 高精度顏色表示、像素格式和色彩空間。
...
- [**ImageInfo**](../api/ImageInfo.md): 畫素維度和編碼方式。
- [**ImageFilter**](../api/ImageFilter.md): 畫素級效果（模糊、陰影）。
- [**IHasImageInfo**](../api/IHasImageInfo.md): 包含 ImageInfo 物件的介面。
